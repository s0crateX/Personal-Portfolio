  ...
  return (
    <div className="max-w-4xl mx-auto p-6 text-black dark:text-white">
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li className="mb-2">
          <p>
            <strong>Service</strong> refers to the Website, any or all apps,
            websites, software, and services we provide.
          </p>
        </li>
        <li className="mb-2">
          <p>
      ...
      <h4 className="text-lg font-semibold mt-4">Business Transactions</h4>
      <p>
      ...
      <h4 className="text-lg font-semibold mt-4">Law Enforcement</h4>
      <p>
      ...
      <h4 className="text-lg font-semibold mt-4">Other Legal Requirements</h4>
      <p>
