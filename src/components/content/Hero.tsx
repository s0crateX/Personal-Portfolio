    ...
    <div className="w-full flex justify-between flex-col-reverse lg:flex-row items-center">
      ...
      <AnimationContainer customClassName="flex flex-col items-center justify-between lg:items-start p-0 lg:pr-8">
        ...
        <h2 className="flex items-center gap-2 text-lg lg:text-xl text-gray-700 dark:text-gray-400 mb-8 mx-auto lg:mx-0">
          <div className="flex flex-col items-center lg:items-start typing-animation">
            <span className="relative w-[max-content] font-mono typing-animation-first text-gray-800 dark:text-gray-200">
              I'm a Full Stack Developer
            </span>
            <span className="relative w-[max-content] font-mono typing-animation-second text-gray-800 dark:text-gray-200 mt-0">
...
<h2 className="flex items-center gap-2 text-lg lg:text-xl text-gray-700 dark:text-gray-400 mb-8 mx-auto lg:mx-0">
  <div className="flex flex-col items-center lg:items-start typing-animation">
    ...
    <span className="relative w-[max-content] font-mono typing-animation-second text-gray-800 dark:text-gray-200">
      and Cyber Security Enthusiast
    </span>
  </div>
</h2>
