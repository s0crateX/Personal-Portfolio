...
// import SupportMe from '@/src/components/content/SupportMe'; // Commented out to hide Support Me section
import FAQSection from '@/src/components/sections/FAQSection';
import StatsSection from '@/src/components/sections/StatsSection';
import SkillsSection from '@/src/components/sections/SkillsSection';
import Badges from '@/src/components/content/Badges';
